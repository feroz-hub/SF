...
public static class RoleHelper
{
    public static RoleModel CreateRoleModel()
    {
        var roleModel = new RoleModel
        {
            ...
            RoleClaims = new List<RoleClaimModel>
            {
                new()
                {
                    ClaimType = "LockUser", ClaimValue = "zentra.role.read", CreatedBy = "Test",
    ...
    public static RoleClaimModel CreateRoleClaimModel()
    {
        ...
        roleClaimModel.ClaimValue = "zentra.role.read";
    ...
    public static List<RoleClaimModel> CreateRoleClaimModel_LabTechnician_2()
    {
        var roleClaimModelList = new List<RoleClaimModel>
        {
            new()
            {
                ClaimType = "CreateUpdateLabTest", ClaimValue = "zentra.role.write", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "DeleteLabTest", ClaimValue = "zentra.role.delete", CreatedBy = "Test2",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "UpdateLabTest", ClaimValue = "zentra.client.write", CreatedBy = "Test3",
                CreatedOn = DateTime.UtcNow
            }
        };
        return roleClaimModelList;
