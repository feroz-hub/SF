...
- API source files cannot reference `Zentra.Infrastructure.*` outside composition root files.
- Domain source files cannot reference `Zentra.Infrastructure.*` namespaces.
