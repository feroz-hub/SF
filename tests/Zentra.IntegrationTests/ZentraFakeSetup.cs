...
using AccessTokenType = Zentra.Domain.Enums.AccessTokenType;
using ApplicationType = Zentra.Domain.Enums.ApplicationType;
using ClientsModel = IntegrationTests.ApiDomainModel.ClientsModel;
using DbTypes = Zentra.Domain.DbTypes;
using IdentityProvider = Zentra.Domain.Enums.IdentityProvider;
using Log = Zentra.Domain.Log;
using LogoutMessageModel = Zentra.Domain.Models.Endpoint.LogoutMessageModel;
using SigningAlgorithm = Zentra.Domain.Enums.SigningAlgorithm;
using UserModel = Zentra.Domain.Models.Api.UserModel;
using WriteLogTo = Zentra.Domain.WriteLogTo;
...
public abstract class ZentraFakeSetup
{
    ...
    private static readonly string IntegrationRuntimeDirectory =
        Path.Combine(Path.GetTempPath(), "zentra-integration-tests");
    ...
    internal readonly Dictionary<string, ClientInfoDictonary> clientMasterData = new()
    {
        ...
        {
            "Zentra Early Token Expire Client",
            new ClientInfoDictonary
            {
    ...
    public ZentraFakeSetup(string basePath = null)
    {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddZentra(systemSettings, tokenSettings, notificationSettings)
    ...
    private static void SeedApiResources(ApplicationDbContext dbContext)
    {
        ...
        var resourceNames = new[]
        {
            ...
            "zentra.role",
            "zentra.apiresource",
            "zentra.identityresource",
            "zentra.adminuser",
            "zentra.securitytoken"
        };
    ...
    private void SeedClients(ApplicationDbContext dbContext)
    {
        ...
        var seedClients = new[]
        {
            new ClientSeedDefinition("Zentra Plain PKCE Client", OpenIdConstants.Algorithms.RsaSha256, true, true, 3600,
                3600, 7200, 1900, 180),
            new ClientSeedDefinition("Zentra S256 Client", OpenIdConstants.Algorithms.RsaSha256, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra Early Token Expire Client", OpenIdConstants.Algorithms.RsaSha256, true,
            ...
            new ClientSeedDefinition("Zentra HS256", OpenIdConstants.Algorithms.HmacSha256, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra HS512", OpenIdConstants.Algorithms.HmacSha512, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra HS384", OpenIdConstants.Algorithms.HmacSha384, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra RS256", OpenIdConstants.Algorithms.RsaSha256, true, true, 3600, 3600, 7200,
                1900, 180),
            new ClientSeedDefinition("Zentra RS512", OpenIdConstants.Algorithms.RsaSha512, true, true, 3600, 3600, 7200,
                1900, 180),
            new ClientSeedDefinition("Zentra RS384", OpenIdConstants.Algorithms.RsaSha384, true, true, 3600, 3600, 7200,
                1900, 180),
            new ClientSeedDefinition("Zentra PS256", OpenIdConstants.Algorithms.RsaSsaPssSha256, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra PS512", OpenIdConstants.Algorithms.RsaSsaPssSha512, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra PS384", OpenIdConstants.Algorithms.RsaSsaPssSha384, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra ES256", OpenIdConstants.Algorithms.EcdsaSha256, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra ES512", OpenIdConstants.Algorithms.EcdsaSha512, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra ES384", OpenIdConstants.Algorithms.EcdsaSha384, true, true, 3600, 3600,
                7200, 1900, 180),
            new ClientSeedDefinition("Zentra ES256 Algorithm Client", OpenIdConstants.Algorithms.EcdsaSha256, true,
                true, 3600, 3600, 7200, 1900, 180)
        };

        var allowedScopes = string.Join(
            " ", "openid", "email", "profile", "phone", "address", "offline_access", "zentra.client", "zentra.user",
            "zentra.role", "zentra.apiresource", "zentra.identityresource", "zentra.adminuser", "zentra.securitytoken");
    ...
    private async Task SeedUsersAsync(IServiceProvider serviceProvider)
    {
        ...
        await EnsureUserAsync(
            ...
            new Users
            {
                ...
                Email = "jacobismail@zentra.local",
    ...
    private static TokenSettings CreateTokenSettings()
    {
        ...
        tokenSettings.TokenConfig.IssuerUri = "security.zentra.com";
    ...
    private static SystemSettings CreateSystemSettings(string databasePath)
    {
        ...
        systemSettings.LogConfig.LogFileConfig.FilePath = Path.Combine(logDirectoryPath, "zentra-integration.log");
    ...
    private static X509Certificate2 CreateSelfSignedRsaCertificate(HashAlgorithmName hashAlgorithm)
    {
        ...
        var request = new CertificateRequest(
            $"CN=ZentraIntegrationRSA-{Guid.NewGuid():N}",
            rsa,
            hashAlgorithm,
    ...
    private static X509Certificate2 CreateSelfSignedEcdsaCertificate(ECCurve curve, HashAlgorithmName hashAlgorithm)
    {
        ...
        var request = new CertificateRequest(
            $"CN=ZentraIntegrationECDSA-{Guid.NewGuid():N}",
            ecdsa,
            hashAlgorithm);
