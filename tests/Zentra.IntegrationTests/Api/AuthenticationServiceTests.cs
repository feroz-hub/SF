...
{
    public class AuthenticationServiceTests : ZentraFakeSetup
    {
        ...
        public async Task SetupAuthenticatorAppAsync_Tests()
        {
            ...
            var result = await authenticationService.SetupAuthenticatorAppAsync(new Guid("763C134B-B796-41F5-B22E-08D9C46BAFAF"), "Zentra");
