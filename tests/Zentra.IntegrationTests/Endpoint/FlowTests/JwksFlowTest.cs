...
public class JwksFlowTest : ZentraFakeSetup
{
    private const string Category = "Introspection endpoint";
    private readonly string audience = "https://server/security/token";

    private readonly string hCLCSEarlyTokenExpireClient = "Zentra Early Token Expire Client";
    private readonly string hclCSES256AlgorithmClient = "Zentra ES256";
    private readonly string hclCSES512AlgorithmClient = "Zentra ES512";

    private readonly string hclCSHS256AlgorithmClient = "Zentra HS256";
    private readonly string hclCSHS512AlgorithmClient = "Zentra HS512";

    private readonly string hclCSPS256AlgorithmClient = "Zentra PS256";
    private readonly string hclCSPS512AlgorithmClient = "Zentra PS512";
    private readonly string hclCSRS256AlgorithmClient = "Zentra RS256";

    private readonly string hclCSRS512AlgorithmClient = "Zentra RS512";
    private readonly string issuer = "security.zentra.com";
