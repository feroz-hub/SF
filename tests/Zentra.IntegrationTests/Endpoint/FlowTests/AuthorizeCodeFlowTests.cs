...
public class AuthorizeCodeFlowTests : ZentraFakeSetup
{
    ...
    private string positiveCaseClientName = "Zentra S256 Client";
    ...
    public async Task AuthorizeCodeFlow_ValidInput_Success()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            ...
            "code",
            "openid email profile zentra.client",
            responseMode: "query",
            prompt: "none",
    ...
    public async Task AuthorizeCodeFlow_MissingClientId_ReturnErrorClientIdMissingInRequest()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            responseType: "code",
            scope: "openid email profile phone zentra.client",
            responseMode: "query",
            prompt: "none",
            codeChallenge: codeVerifier,
            codeChallengeMethod: "plain",
    ...
    public async Task AuthorizeCodeFlow_InvalidClientId_ReturnErrorClientDoesNotExist()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            ...
            "code",
            "openid email profile phone zentra.client",
            responseMode: "query",
            prompt: "none",
            codeChallenge: codeVerifier,
            codeChallengeMethod: "plain",
    ...
    public async Task AuthCodeFlow_CodeChallengeMethodS256_ReturnSuccess()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            clientModel.ClientId,
            "code",
            "openid zentra.client offline_access zentra.role zentra.user zentra.apiresource",
            // "openid email profile phone",
            responseMode: "query",
            prompt: "none",
