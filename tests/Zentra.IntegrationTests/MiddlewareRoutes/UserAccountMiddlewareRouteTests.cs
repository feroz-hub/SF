...
//    /// </summary>
//    public class UserAccountMiddlewareRouteTests : ZentraFakeSetup
//    {
...
//            var url = ZentraFakeSetup.BaseUrl + ApiRoutePathConstants.LockUserPath;
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = ZentraFakeSetup.BaseUrl + ApiRoutePathConstants.LockUserWithEndDatePath;
//            var response = await FrontChannelClient.PostAsync(
//                url,
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = ZentraFakeSetup.BaseUrl + ApiRoutePathConstants.AddApiResource;
//            var response = await FrontChannelClient.PostAsync(
//                url,
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = ZentraFakeSetup.BaseUrl + ApiRoutePathConstants.GetActiveSecurityTokensByClientIds;
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = ZentraFakeSetup.BaseUrl + ApiRoutePathConstants.GetActiveSecurityTokensByUserIds;
//            var httpresponse = await FrontChannelClient.PostAsync(
//                url,
//                new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json"));
//            var response = await httpresponse.Content.ReadAsStringAsync();
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = ZentraFakeSetup.BaseUrl + ApiRoutePathConstants.GetActiveSecurityTokensBetweenDates;
//            var httpresponse = await FrontChannelClient.PostAsync(
//                url,
//                new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json"));
//            var response = await httpresponse.Content.ReadAsStringAsync();
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = ZentraFakeSetup.BaseUrl + ApiRoutePathConstants.GetAllSecurityTokensBetweenDates;
//            var httpresponse = await FrontChannelClient.PostAsync(
//                url,
//                new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json"));
//            var response = await httpresponse.Content.ReadAsStringAsync();
