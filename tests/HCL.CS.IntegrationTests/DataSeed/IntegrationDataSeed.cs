...
public static class IntegrationDataSeed
{
    ...
    public static List<RoleClaimModel> CreateRoleClaimModel_RoleAdmin()
    {
        var roleClaimModelList = new List<RoleClaimModel>
        {
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Role.Read", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Role.Write", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Role.Delete", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Role.Manage", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            }
        };
    ...
    public static List<RoleClaimModel> CreateRoleClaimModel_SystemAdmin()
    {
        var roleClaimModelList = new List<RoleClaimModel>
        {
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Admin.Manage", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            }
        };
        return roleClaimModelList;
    ...
    public static List<RoleClaimModel> CreateRoleClaimModel_ClientAdmin()
    {
        var roleClaimModelList = new List<RoleClaimModel>
        {
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Cleint.Read", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Cleint.Write", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Cleint.Delete", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.Cleint.Manage", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            }
        };
        return roleClaimModelList;
    ...
    public static List<RoleClaimModel> CreateRoleClaimModel_GeneralUser()
    {
        var roleClaimModelList = new List<RoleClaimModel>
        {
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.User.Read", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.User.Write", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.User.Delete", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.User.Manage", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            }
        };
        return roleClaimModelList;
    ...
    public static List<RoleClaimModel> CreateRoleClaimModel_ResourceAdmin()
    {
        var roleClaimModelList = new List<RoleClaimModel>
        {
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.ApiResource.Read", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.ApiResource.Write", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.ApiResource.Delete", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.ApiResource.Manage", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },

            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.IdentityResource.Read", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.IdentityResource.Write", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.IdentityResource.Delete", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            },
            new()
            {
                ClaimType = "permission", ClaimValue = "HCL.CS.IdentityResource.Manage", CreatedBy = "Test",
                CreatedOn = DateTime.UtcNow
            }
        };
        return roleClaimModelList;
    ...
    public static List<ApiResourcesModel> CreateApiResourceModelMaster()
    {
        ...
        var apiResource1 = new ApiResourcesModel
        {
            ...
            ApiScopes = new List<ApiScopesModel>
            {
                new()
                {
                    Name = "HCL.CS.Role.Read", Description = "ReadOnly access for Role Api", CreatedBy = "JohnDoe"
                },
                new()
                {
                    Name = "HCL.CS.Role.Write", Description = "Create/Update access for Role Api", CreatedBy = "JohnDoe"
                },
                new()
                {
                    Name = "HCL.CS.Role.Delete", Description = "Delete access for Role Api", CreatedBy = "JohnDoe"
                },
                new()
                {
                    Name = "HCL.CS.Role.Manage", Description = "Read/Write/Delete access for Role Api",
                    CreatedBy = "JohnDoe",
        ...
        var apiResource2 = new ApiResourcesModel
        {
            ...
            ApiScopes = new List<ApiScopesModel>
            {
                new()
                {
                    Name = "HCL.CS.Client.Read", Description = "ReadOnly access for Client Api", CreatedBy = "Test"
                },
                new() { Name = "HCL.CS.Client.Write", Description = "Write access for Client Api", CreatedBy = "Test" },
                new()
                {
                    Name = "HCL.CS.Client.Delete", Description = "Delete access for Client Api", CreatedBy = "Test"
                },
                new()
                {
                    Name = "HCL.CS.Client.Manage", Description = "Read/Write/Delete access for Client Api",
                    CreatedBy = "Test"
                }
            }
        };
        var apiResource3 = new ApiResourcesModel
        {
            ...
            ApiScopes = new List<ApiScopesModel>
            {
                new() { Name = "HCL.CS.User.Read", Description = "ReadOnly access for Client Api", CreatedBy = "Test" },
                new() { Name = "HCL.CS.User.Write", Description = "Write access for Client Api", CreatedBy = "Test" },
                new() { Name = "HCL.CS.User.Delete", Description = "Delete access for Client Api", CreatedBy = "Test" },
                new()
                {
                    Name = "HCL.CS.User.Manage", Description = "Read/Write/Delete access for Client Api",
                    CreatedBy = "Test"
                }
            }
        };
        ...
        var apiResource4 = new ApiResourcesModel
        {
            ...
            ApiScopes = new List<ApiScopesModel>
            {
                new()
                {
                    Name = "HCL.CS.ApiResource.Read", Description = "ReadOnly access for Client Api", CreatedBy = "Test"
                },
                new()
                {
                    Name = "HCL.CS.ApiResource.Write", Description = "Write access for Client Api", CreatedBy = "Test"
                },
                new()
                {
                    Name = "HCL.CS.ApiResource.Delete", Description = "Delete access for Client Api", CreatedBy = "Test"
                },
                new()
                {
                    Name = "HCL.CS.ApiResource.Manage", Description = "Read/Write/Delete access for Client Api",
                    CreatedBy = "Test"
                }
            }
        };
        ...
        var apiResource5 = new ApiResourcesModel
        {
            ...
            ApiScopes = new List<ApiScopesModel>
            {
                new()
                {
                    Name = "HCL.CS.IdentityResource.Read", Description = "ReadOnly access for Client Api",
                    CreatedBy = "Test"
                },
                new()
                {
                    Name = "HCL.CS.IdentityResource.Write", Description = "Write access for Client Api",
                    CreatedBy = "Test"
                },
                new()
                {
                    Name = "HCL.CS.IdentityResource.Delete", Description = "Delete access for Client Api",
                    CreatedBy = "Test"
                },
                new()
                {
                    Name = "HCL.CS.IdentityResource.Manage", Description = "Read/Write/Delete access for Client Api",
                    CreatedBy = "Test"
                }
            }
        };
        var apiResource6 = new ApiResourcesModel
        {
            ...
            ApiScopes = new List<ApiScopesModel>
            {
                new()
                {
                    Name = "HCL.CS.Admin.Manage", Description = "Read/Write/Delete access for Client Api",
                    CreatedBy = "Test"
                }
            }
        };
    ...
    public static List<ClientsModel> CreateClientMaster()
    {
        ...
        {
            ClientId = 32.RandomString(),
            ClientName = "HCL.CS Plain PKCE Client",
            ClientUri = "https://identity:5002",
            ClientSecret = 32.RandomString(),
            ClientIdIssuedAt = DateTime.Now,
            ClientSecretExpiresAt = DateTime.Now.AddDays(180),
        ...
        {
            ClientId = 32.RandomString(),
            ClientName = "HCL.CS Early Token Expire Client",
            ClientUri = "https://identity:5002",
            ClientSecret = 32.RandomString(),
            ClientIdIssuedAt = DateTime.Now,
            ClientSecretExpiresAt = DateTime.Now.AddDays(180),
        ...
        {
            ClientId = 32.RandomString(),
            ClientName = "HCL.CS ES256 Algorithm Client",
            ClientUri = "https://identity:5002",
            ClientSecret = 32.RandomString(),
            ClientIdIssuedAt = DateTime.Now,
            ClientSecretExpiresAt = DateTime.Now.AddDays(180),
        ...
        {
            ClientId = 32.RandomString(),
            ClientName = "HCL.CS DisableClientSecret Client",
            ClientUri = "https://identity:5002",
            ClientSecret = 32.RandomString(),
            ClientIdIssuedAt = DateTime.Now,
            ClientSecretExpiresAt = DateTime.Now.AddDays(180),
