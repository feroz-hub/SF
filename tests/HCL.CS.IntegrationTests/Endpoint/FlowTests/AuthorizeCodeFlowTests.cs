...
public class AuthorizeCodeFlowTests : HclCsFakeSetup
{
    ...
    public async Task AuthorizeCodeFlow_ValidInput_Success()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            ...
            "code",
            "openid email profile hcl-cs.client",
            responseMode: "query",
            prompt: "none",
    ...
    public async Task AuthorizeCodeFlow_MissingClientId_ReturnErrorClientIdMissingInRequest()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            responseType: "code",
            scope: "openid email profile phone hcl-cs.client",
            responseMode: "query",
            prompt: "none",
            codeChallenge: codeVerifier.GenerateCodeChallenge(),
            codeChallengeMethod: "S256",
    ...
    public async Task AuthorizeCodeFlow_InvalidClientId_ReturnErrorClientDoesNotExist()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            ...
            "code",
            "openid email profile phone hcl-cs.client",
            responseMode: "query",
            prompt: "none",
            codeChallenge: codeVerifier.GenerateCodeChallenge(),
            codeChallengeMethod: "S256",
    ...
    public async Task AuthCodeFlow_CodeChallengeMethodS256_ReturnSuccess()
    {
        ...
        var authcodeRequest = CreateAuthorizeRequestUrl(
            clientModel.ClientId,
            "code",
            "openid hcl-cs.client offline_access hcl-cs.role hcl-cs.user hcl-cs.apiresource",
            // "openid email profile phone",
            responseMode: "query",
            prompt: "none",
