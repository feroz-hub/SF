// * Copyright (c) 2021 HCL.CS CORPORATION.
// * All rights reserved. HCL.CS source code is an unpublished work and the use of a copyright notice does not imply otherwise.
// * This source code contains confidential, trade secret material of HCL.CS. Any attempt or participation in deciphering,
// * decoding, reverse engineering or in any way altering the source code is strictly prohibited, unless the prior written consent of
// * HCL.CS is obtained. This is proprietary and confidential to HCL.CS.
// */
...
//    /// </summary>
//    public class UserAccountMiddlewareRouteTests : HclCsFakeSetup
//    {
...
//            var url = HclCsFakeSetup.BaseUrl + ApiRoutePathConstants.LockUserPath;
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = HclCsFakeSetup.BaseUrl + ApiRoutePathConstants.LockUserWithEndDatePath;
//            var response = await FrontChannelClient.PostAsync(
//                url,
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = HclCsFakeSetup.BaseUrl + ApiRoutePathConstants.AddApiResource;
//            var response = await FrontChannelClient.PostAsync(
//                url,
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = HclCsFakeSetup.BaseUrl + ApiRoutePathConstants.GetActiveSecurityTokensByClientIds;
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = HclCsFakeSetup.BaseUrl + ApiRoutePathConstants.GetActiveSecurityTokensByUserIds;
//            var httpresponse = await FrontChannelClient.PostAsync(
//                url,
//                new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json"));
//            var response = await httpresponse.Content.ReadAsStringAsync();
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = HclCsFakeSetup.BaseUrl + ApiRoutePathConstants.GetActiveSecurityTokensBetweenDates;
//            var httpresponse = await FrontChannelClient.PostAsync(
//                url,
//                new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json"));
//            var response = await httpresponse.Content.ReadAsStringAsync();
...
//            // Call lock user middleware
//            FrontChannelClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.access_token);
//            var url = HclCsFakeSetup.BaseUrl + ApiRoutePathConstants.GetAllSecurityTokensBetweenDates;
//            var httpresponse = await FrontChannelClient.PostAsync(
//                url,
//                new StringContent(JsonConvert.SerializeObject(data), Encoding.UTF8, "application/json"));
//            var response = await httpresponse.Content.ReadAsStringAsync();
