        ...
        <header className="card-head">
          <div>
            ...
            <p className="text-caption" style={{ marginTop: "0.35rem" }}>
              Call any HCL.CS API. Build the request with <strong>Form</strong> fields (no JSON needed) or switch to <strong>Raw JSON</strong>. Your session token is sent automatically.{" "}
