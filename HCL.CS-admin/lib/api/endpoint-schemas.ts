...
export const endpointSchemas: Record<string, EndpointSchema> = {
  ...
  "/Security/Api/ApiResource/AddApiResource": {
    ...
    fields: [
      { name: "name", type: "string", required: true, placeholder: "e.g. hcl-cs.apiresource" },
      { name: "displayName", type: "string", required: true, placeholder: "e.g. HCL.CS API" },
  ...
  "/Security/Api/ApiResource/DeleteApiResourceByName": {
    ...
    fields: [{ name: "apiResourceName", type: "string", required: true, placeholder: "e.g. hcl-cs.apiresource" }],
  },
  ...
  "/Security/Api/ApiResource/AddApiScope": {
    ...
    fields: [
      ...
      { name: "name", type: "string", required: true, placeholder: "e.g. hcl-cs.read" },
  ...
  "/Security/Api/ApiResource/DeleteApiScopeByName": {
    ...
    fields: [{ name: "apiScopeName", type: "string", required: true, placeholder: "e.g. hcl-cs.read" }],
  },
  ...
  "/Security/Api/Authentication/SetupAuthenticatorApp": {
    ...
    fields: [
      guidId("userId", "User ID"),
      { name: "applicationName", type: "string", required: true, placeholder: "e.g. HCL.CS Identity" },
    ],
  },
  ...
  "/setup/connection": {
    ...
    fields: [
      { name: "connectionString", type: "string", required: true, placeholder: "e.g. Host=localhost;Database=hcl-cs;..." },
    ],
  },
  "/setup/validate": {
    method: "POST",
