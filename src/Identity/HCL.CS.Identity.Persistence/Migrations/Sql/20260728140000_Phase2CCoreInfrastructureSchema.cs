    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ConfigJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                AutoProvisionEnabled = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                AllowedDomains = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                LastTestedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                LastTestSuccess = table.Column<bool>(type: "bit", nullable: true)
            },
            constraints: table =>
