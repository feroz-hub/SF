...
* <p>&nbsp;Below diagram represents the overall HCL.CS architecture and its components&rsquo; interaction with each other.</p>
* \image html SoftwareArchitecture.jpg
* <p><center><strong> HCL.CS &ndash; High Level Architecture </strong></center></p>
...
* <p>The HCL.CS uses Microsoft ASP.NET Identity as the foundation to manage user authentication, roles, and user profiles. ASP.NET Identity Framework feature is customized as per industry standards to meet security objectives.</p>
...
* </ul>
* <p>&nbsp;In addition to identity management, HCL.CS exposes OAuth2.0 and OpenID Connect compliant endpoints to handle user authentication and token management.</p>
