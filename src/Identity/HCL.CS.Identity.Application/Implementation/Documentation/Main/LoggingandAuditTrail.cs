...
* <p>HCL.CS supports the diagnostic logging for the client application.
* The log file records the events that occur in the HCL.CS. This type of diagnostic logging helps the developers to analyze the code and debug if an unexpected error scenario happens in the production environment. </p>
...
* <p>HCL.CS supports logging to a file based on the criticality of the messages logged.
* There are two types of messages defined in the HCL.CS.</p>
* <ul>
...
* </ul>
* <p>After the HCL.CS is integrated, the server application can instantiate their own logger instance provided readily.</p>
...
* \endcode
* <p><strong>Note:&nbsp;</strong>A unique instance name is used for logging all the HCL.CS related components.</p>
* <p><strong>AuditTrail</strong></p>
* <p>HCL.CS supports logging all the detailed transactions relating to changes in any item in the fields of a table in the database supported.</p>
