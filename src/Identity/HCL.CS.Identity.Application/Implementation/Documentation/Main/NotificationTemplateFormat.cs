...
* <p>Notifications are sent to the user and administrators in a format defined in the HCL.CS.
...
* The Subject, FromAddress and FromName are mandatory items to be filled. The "TemplateFormat" defined can have HCL.CS defined placeholders like {USERNAME}, {FIRSTNAME} etc.
...
* The "TemplateFormat" defined can have HCL.CS defined placeholders similar to the email template like {USERNAME}, {FIRSTNAME} etc. The placeholders are case sensitive and should be encapsulated within the braces ({}).
