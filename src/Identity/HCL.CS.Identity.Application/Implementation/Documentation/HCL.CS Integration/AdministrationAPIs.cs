...
* <p><strong>Admin User Capablities in the HCL.CS </strong></p>
* <p>The Admin user is responsible to configure metadata/master data to run the HCL.CS as intended.</p>
...
* </li>
* </ul>
<p>If the above information is not configured by the administrator, the HCL.CS will fail due to insufficient dependent data that are need to generate tokens.</p>
* <p><strong>The Calling procedure for APIs in the HCL.CS</strong></p>
* <table>
* <tr>
