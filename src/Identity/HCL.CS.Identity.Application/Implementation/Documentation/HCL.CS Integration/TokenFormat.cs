...
* <p>The default token type ( <strong> token_type) </strong> that is supported in the HCL.CS is the &ldquo; <strong> Bearer </strong> &rdquo; token type.</p>
* <p>The &ldquo; <strong> Reference </strong> &rdquo; token type is not supported in the HCL.CS.</p>
...
* <p>The following are some of the &ldquo;Bearer&rdquo; tokens generated in the HCL.CS.</p>
* <table>
* <tr>
* <td>
...
* <p>The HCL.CS provides the identity token when the scope input parameter value contains &ldquo;openid&rdquo;.</p>
* </td>
* </tr>
* <tr>
* <td>
...
* <p>The HCL.CS provides the refresh token when the scope input parameter value contains &ldquo;offline_access&rdquo;.</p>
* </td>
* </tr>
* </table>
* <p><strong> Token Format </strong></p>
* <p>The access token and the identity token supported by the HCL.CS are in JWT format.&nbsp;</p>
...
* </ul>
* <ul>
* <li>The bit strength for the encryption supported by the HCL.CS are 256, 384 and 512 for each type of algorithm.&nbsp;</li>
* <li><strong> HMAC </strong> uses <strong> the client id </strong> as the Shared Key for creating the signature.</li>
* <li>The default signing algorithm is HMAC-SHA256 if the client does not specify a signing algorithm while registering in the HCL.CS.&nbsp;</li>
...
* </ul>
* <p>The following algorithms are supported by the HCL.CS for signing the access and identity tokens.&nbsp;</p>
* <table>
* <tr>
* <td>
* <p><strong> S.No </strong></p>
...
* <p>The following prompt modes are supported in the authorization endpoint of the HCL.CS&nbsp;</p>
* <table>
* <tr>
* <td>
