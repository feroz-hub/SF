...
* For configuring the HCL.CS in the client web application,
...
* \code
           .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
           {
               ...
               options.Scope.Add("hcl-cs.apiresource");
               options.Scope.Add("hcl-cs.client");
               options.Scope.Add("hcl-cs.user");
               options.Scope.Add("hcl-cs.role");
               options.Scope.Add("hcl-cs.identityresource");
               options.Scope.Add("hcl-cs.adminuser");
               options.Scope.Add("hcl-cs.securitytoken");
