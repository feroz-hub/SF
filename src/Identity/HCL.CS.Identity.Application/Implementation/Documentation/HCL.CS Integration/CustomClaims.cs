...
* </ul>
* <p>The following table shows the Identity resources and the identity claims configured in the HCL.CS.</p>
* <table>
* <tr>
...
* <p>There are four tables available in the HCL.CS to configure the access to the apis available. These tables can be used by the client application to provide authorization to their own api&rsquo;s also.</p>
...
* <p>The following are the permissions defined in the HCL.CS</p>
* <ul>
* <li>Read</li>
* <li>Write</li>
* <li>Delete</li>
