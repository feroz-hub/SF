/**
* @page IntegrationApproach HCL.CS Integration
* <p><strong> HCL.CS Hosting Prerequisites </strong></p>
* <ul>
...
* <li>LDAP configuration with domain, port, and certificates (for SSL connection), If HCL.CS needs to create user account from existing LDAP server. This is optional. If not configured, the user account will be created with direct input from the user.</li>
...
* </ul>
* <p><strong> HCL.CS Integration Approach </strong></p>
* <ul>
* <li>HCL.CS can be integrated only to .NET core based server application, since all inputs are validated using HTTPContext values such as user authentication information, token etc.</li>
* <li>HCL.CS endpoints can be invoked only via server hosted Restful services.</li>
...
* <p>The following steps needs to be followed for integrating and utilizing the HCL.CS authorization/authentication features</p>
