...
* \code
    <appSettings>
        ...
        <add key="AuthScope" value="openid email profile offline_access phone hcl-cs.apiresource hcl-cs.client hcl-cs.user hcl-cs.role hcl-cs.identityresource hcl-cs.adminuser hcl-cs.securitytoken"/>
        <add key="AuthResponseMode" value="query"/>
        <add key="Prompt" value="none"/>
        <add key="RedirectUri" value="http://127.0.0.1:63562/"/>
        <add key="ClientScope" value="hcl-cs.client"/>
        <add key="HybridScope" value="openid hcl-cs.client email profile offline_access"/>
        ...
        <add key="RefreshTokenScope" value="openid email profile phone hcl-cs.client offline_access"/>
