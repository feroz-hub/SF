...
internal class AuthorizeResult : IEndpointResult
{
    ...
    private HclCsConfig frameworkConfig;
    ...
    {
        frameworkConfig = context.RequestServices.GetRequiredService<HclCsConfig>();
    ...
    private async Task RedirectToErrorPageAsync(HttpContext context)
    {
        ...
        var host = context.GetHclCsBaseUrl().IncludeEndSlash();
