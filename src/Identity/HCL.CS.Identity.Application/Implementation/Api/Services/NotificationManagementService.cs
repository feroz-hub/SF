...
public class NotificationManagementService : SecurityBase, INotificationManagementService
{
    ...
    private readonly HclCsConfig _hclCsConfig;
    ...
    public virtual Task<NotificationTemplateResponseModel> GetNotificationTemplatesAsync()
    {
        ...
        {
            EmailTemplates = _hclCsConfig.NotificationTemplateSettings?.EmailTemplateCollection ?? new List<EmailTemplate>(),
            SmsTemplates = _hclCsConfig.NotificationTemplateSettings?.SMSTemplateCollection ?? new List<SMSTemplate>()
        };
    ...
    public virtual async Task<FrameworkResult> SendTestNotificationAsync(SendTestNotificationRequest request)
    {
        try
        {
            ...
            var fromName = config.GetValueOrDefault("FromName", "HCL.CS");
