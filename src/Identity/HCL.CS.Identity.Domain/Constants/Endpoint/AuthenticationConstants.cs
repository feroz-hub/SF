...
public static class AuthenticationConstants
{
    ...
    public const string HclCsName = "HCL.CS";
    public const string HclCsType = HclCsName;
    ...
    //public const string DefaultCookieAuthenticationScheme = "hcl-cs.Identity";
    //public const string SignoutScheme = "hcl-cs.Identity";
    //public const string ExternalCookieAuthenticationScheme = "hcl-cs.External";
    ...
    {
        public const string HclCsBasePath = "hcl-cs:HclCsServerBasePath";
        public const string SignOutCalled = "hcl-cs:HclCsServerSignOutCalled";
    }
