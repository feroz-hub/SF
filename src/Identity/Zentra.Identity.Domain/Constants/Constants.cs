namespace Zentra.Domain.Constants;
...
public class Constants
{
    ...
    // public const string DefaultDbSchema = "zentra";
...
{
    public const string DefaultEncryptionKey = "CSZentra";
...
{
    public const string DefaultLoggerKey = "CSZentra";
}
