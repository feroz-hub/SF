...
internal class AuthorizeResult : IEndpointResult
{
    ...
    private ZentraConfig frameworkConfig;
    ...
    {
        frameworkConfig = context.RequestServices.GetRequiredService<ZentraConfig>();
    ...
    private async Task RedirectToErrorPageAsync(HttpContext context)
    {
        ...
        var host = context.GetZentraBaseUrl().IncludeEndSlash();
