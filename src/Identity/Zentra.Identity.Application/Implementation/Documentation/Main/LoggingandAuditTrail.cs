...
* <p>Zentra supports the diagnostic logging for the client application.
* The log file records the events that occur in the Zentra. This type of diagnostic logging helps the developers to analyze the code and debug if an unexpected error scenario happens in the production environment. </p>
...
* <p>Zentra supports logging to a file based on the criticality of the messages logged.
* There are two types of messages defined in the Zentra.</p>
* <ul>
...
* </ul>
* <p>After the Zentra is integrated, the server application can instantiate their own logger instance provided readily.</p>
...
* \endcode
* <p><strong>Note:&nbsp;</strong>A unique instance name is used for logging all the Zentra related components.</p>
* <p><strong>AuditTrail</strong></p>
* <p>Zentra supports logging all the detailed transactions relating to changes in any item in the fields of a table in the database supported.</p>
