/**
* @page ZentraMiddlewareHosting Zentra Middleware Hosting
...
* </ul>
* <p>Zentra has middleware extension which is created using <strong>IApplicationBuilder</strong>, it can be consumed in the middleware hosting. Once Zentra middleware extension component integrated into target application, and then it is capable to handle OAuth/API request and responses via HTTPContext.</p>
*/
