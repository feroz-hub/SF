...
* \code
    <appSettings>
        ...
        <add key="AuthScope" value="openid email profile offline_access phone zentra.apiresource zentra.client zentra.user zentra.role zentra.identityresource zentra.adminuser zentra.securitytoken"/>
        <add key="AuthResponseMode" value="query"/>
        <add key="Prompt" value="none"/>
        <add key="RedirectUri" value="http://127.0.0.1:63562/"/>
        <add key="ClientScope" value="zentra.client"/>
        <add key="HybridScope" value="openid zentra.client email profile offline_access"/>
        ...
        <add key="RefreshTokenScope" value="openid email profile phone zentra.client offline_access"/>
