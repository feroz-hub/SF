/**
* @page IntegrationApproach Zentra Integration
* <p><strong> Zentra Hosting Prerequisites </strong></p>
* <ul>
...
* <li>LDAP configuration with domain, port, and certificates (for SSL connection), If Zentra needs to create user account from existing LDAP server. This is optional. If not configured, the user account will be created with direct input from the user.</li>
...
* </ul>
* <p><strong> Zentra Integration Approach </strong></p>
* <ul>
* <li>Zentra can be integrated only to .NET core based server application, since all inputs are validated using HTTPContext values such as user authentication information, token etc.</li>
* <li>Zentra endpoints can be invoked only via server hosted Restful services.</li>
...
* <p>The following steps needs to be followed for integrating and utilizing the Zentra authorization/authentication features</p>
