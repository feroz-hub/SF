...
* For configuring the Zentra in the client web application,
...
* \code
           .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
           {
               ...
               options.Scope.Add("zentra.apiresource");
               options.Scope.Add("zentra.client");
               options.Scope.Add("zentra.user");
               options.Scope.Add("zentra.role");
               options.Scope.Add("zentra.identityresource");
               options.Scope.Add("zentra.adminuser");
               options.Scope.Add("zentra.securitytoken");
