...
using Zentra.DemoClientWpfApp.Extension;
using Zentra.DemoClientWpfApp.ViewModel;

namespace Zentra.DemoClientWpfApp.Services
{
    ...
    internal class HttpService :BaseModel
    {
        ...
        public string GeneratePrivateJWTRequest(ClientsModel client)
        {
            ...
            string CertPath = "C:\\Source\\Zentra.NET6.CROSS_PLATFORM\\PrivateAndPublicKey\\privatejwt.pfx";
