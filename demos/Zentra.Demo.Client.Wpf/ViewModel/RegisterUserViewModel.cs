...
using DomainModel_FrameworkResult = Zentra.DemoClientWpfApp.DomainModel.FrameworkResult;
using FrameworkResult = Zentra.DemoClientWpfApp.DomainModel.FrameworkResult;
using IdentityProvider = Zentra.DemoClientWpfApp.DomainModel.IdentityProvider;
using TwoFactorType = Zentra.DemoClientWpfApp.DomainModel.TwoFactorType;
