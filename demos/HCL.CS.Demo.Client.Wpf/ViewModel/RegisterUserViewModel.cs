...
using DomainModel_FrameworkResult = HCL.CS.DemoClientWpfApp.DomainModel.FrameworkResult;
using FrameworkResult = HCL.CS.DemoClientWpfApp.DomainModel.FrameworkResult;
using IdentityProvider = HCL.CS.DemoClientWpfApp.DomainModel.IdentityProvider;
using TwoFactorType = HCL.CS.DemoClientWpfApp.DomainModel.TwoFactorType;
