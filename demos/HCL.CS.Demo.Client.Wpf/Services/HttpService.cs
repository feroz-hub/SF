...
using HCL.CS.DemoClientWpfApp.Extension;
using HCL.CS.DemoClientWpfApp.ViewModel;

namespace HCL.CS.DemoClientWpfApp.Services
{
    ...
    internal class HttpService :BaseModel
    {
        ...
        public string GeneratePrivateJWTRequest(ClientsModel client)
        {
            ...
            string CertPath = "C:\\Source\\HCL.CS.NET6.CROSS_PLATFORM\\PrivateAndPublicKey\\privatejwt.pfx";
