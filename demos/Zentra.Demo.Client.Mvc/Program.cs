...
using Zentra.DemoClientMvc.Middlewares;
using Zentra.DemoClientMvc.Options;
using Zentra.DemoClientMvc.Service;
...
{
    options.Cookie.Name = "__Host.Zentra.DemoClient.Session";
...
builder.Services.AddAuthentication(options =>
    ...
    {
        options.Cookie.Name = "__Host.Zentra.DemoClient.Auth";
        options.Cookie.HttpOnly = true;
        options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
        options.Cookie.SameSite = SameSiteMode.Lax;
        options.Cookie.IsEssential = true;
    ...
    .AddOpenIdConnect(OpenIdConnectDefaults.AuthenticationScheme, options =>
    {
        ...
        options.CorrelationCookie.Name = "__Host.Zentra.DemoClient.Correlation";
        options.CorrelationCookie.HttpOnly = true;
        options.CorrelationCookie.SecurePolicy = CookieSecurePolicy.Always;
        options.CorrelationCookie.SameSite = SameSiteMode.None;
        options.NonceCookie.Name = "__Host.Zentra.DemoClient.Nonce";
...
if (app.Environment.IsDevelopment())
{
    ...
    if (string.IsNullOrWhiteSpace(oauthOptions.ClientSecret))
    {
        ...
        logger.LogWarning(
            ...
            "Use the client secret shown when you completed the Zentra installer.");
    }
}
