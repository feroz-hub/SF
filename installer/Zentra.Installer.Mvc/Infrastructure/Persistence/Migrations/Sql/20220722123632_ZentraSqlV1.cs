...
namespace ZentraInstallerMVC.Infrastructure.Persistence.Migrations.Sql;

public partial class ZentraSqlV1 : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.ForeignKey(
                    "FK_Zentra_UserSecurityQuestions_Zentra_SecurityQuestions_SecurityQuestionId",
        ...
        migrationBuilder.CreateIndex(
            "IX_Zentra_ClientPostLogoutRedirectUris_ClientId_PostLogoutRedirectUri",
            "Zentra_ClientPostLogoutRedirectUris",
