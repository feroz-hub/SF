...
export const endpointSchemas: Record<string, EndpointSchema> = {
  ...
  "/Security/Api/ApiResource/AddApiResource": {
    ...
    fields: [
      { name: "name", type: "string", required: true, placeholder: "e.g. zentra.apiresource" },
      { name: "displayName", type: "string", required: true, placeholder: "e.g. Zentra API" },
  ...
  "/Security/Api/ApiResource/DeleteApiResourceByName": {
    ...
    fields: [{ name: "apiResourceName", type: "string", required: true, placeholder: "e.g. zentra.apiresource" }],
  },
  ...
  "/Security/Api/ApiResource/AddApiScope": {
    ...
    fields: [
      ...
      { name: "name", type: "string", required: true, placeholder: "e.g. zentra.read" },
  ...
  "/Security/Api/ApiResource/DeleteApiScopeByName": {
    ...
    fields: [{ name: "apiScopeName", type: "string", required: true, placeholder: "e.g. zentra.read" }],
  },
  ...
  "/Security/Api/Authentication/RopValidateCredentials": {
    ...
    fields: [
      ...
      { name: "scope", type: "string", required: true, placeholder: "e.g. zentra.apiresource zentra.client" },
    ],
  },
  ...
  "/Security/Api/Authentication/SetupAuthenticatorApp": {
    ...
    fields: [
      guidId("userId", "User ID"),
      { name: "applicationName", type: "string", required: true, placeholder: "e.g. Zentra Identity" },
    ],
  },
  ...
  "/security/token": {
    ...
    fields: [
      ...
      { name: "scope", type: "string", placeholder: "e.g. openid profile zentra.apiresource" },
  ...
  "/setup/connection": {
    ...
    fields: [
      { name: "connectionString", type: "string", required: true, placeholder: "e.g. Host=localhost;Database=zentra;..." },
    ],
  },
  "/setup/validate": {
    method: "POST",
