...
export async function passwordSignIn(payload: PasswordSignInRequest): Promise<SignInResponseModel> {
  return zentraPostWithSession<SignInResponseModel, PasswordSignInRequest>(ApiRoutes.authentication.passwordSignIn, payload);
}
...
export async function passwordSignInByTwoFactorAuthenticatorToken(
  ...
  return zentraPostWithSession<SignInResponseModel, PasswordSignInByTwoFactorAuthenticatorTokenRequest>(
...
export async function twoFactorAuthenticatorAppSignIn(code: string): Promise<SignInResponseModel> {
  return zentraPostWithSession<SignInResponseModel, string>(ApiRoutes.authentication.twoFactorAuthenticatorAppSignIn, code);
}

export async function twoFactorEmailSignIn(code: string): Promise<SignInResponseModel> {
  return zentraPostWithSession<SignInResponseModel, string>(ApiRoutes.authentication.twoFactorEmailSignIn, code);
}

export async function twoFactorRecoveryCodeSignIn(code: string): Promise<SignInResponseModel> {
  return zentraPostWithSession<SignInResponseModel, string>(ApiRoutes.authentication.twoFactorRecoveryCodeSignIn, code);
}

export async function twoFactorSmsSignIn(code: string): Promise<SignInResponseModel> {
  return zentraPostWithSession<SignInResponseModel, string>(ApiRoutes.authentication.twoFactorSmsSignInAsync, code);
}

export async function ropValidateCredentials(payload: unknown): Promise<unknown> {
  return zentraPostWithSession<unknown, unknown>(ApiRoutes.authentication.ropValidateCredentials, payload);
}

export async function isUserSignedIn(payload: unknown): Promise<unknown> {
  return zentraPostWithSession<unknown, unknown>(ApiRoutes.authentication.isUserSignedIn, payload);
}

export async function signOut(): Promise<FrameworkResult> {
  return zentraPostWithSession<FrameworkResult, string>(ApiRoutes.authentication.signOut, "");
}
...
export async function setupAuthenticatorApp(payload: SetupAuthenticatorAppRequest): Promise<AuthenticatorAppSetupResponseModel> {
  return zentraPostWithSession<AuthenticatorAppSetupResponseModel, SetupAuthenticatorAppRequest>(
...
export async function verifyAuthenticatorAppSetup(payload: VerifyAuthenticatorAppSetupRequest): Promise<AuthenticatorAppResponseModel> {
  return zentraPostWithSession<AuthenticatorAppResponseModel, VerifyAuthenticatorAppSetupRequest>(
...
export async function resetAuthenticatorApp(userId: UUID): Promise<FrameworkResult> {
  return zentraPostWithSession<FrameworkResult, UUID>(ApiRoutes.authentication.resetAuthenticatorApp, userId);
}

export async function generateRecoveryCodes(userId: UUID): Promise<string[]> {
  return zentraPostWithSession<string[], UUID>(ApiRoutes.authentication.generateRecoveryCodes, userId);
}

export async function countRecoveryCodes(userId: UUID): Promise<number> {
  return zentraPostWithSession<number, UUID>(ApiRoutes.authentication.countRecoveryCodesAsync, userId);
}
