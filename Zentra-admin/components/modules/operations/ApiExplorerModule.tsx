        ...
        JSON.stringify(
          {
            ...
            scope: "zentra.apiresource zentra.client"
          },
          null,
          2
        )
        ...
        <header className="card-head">
          <div>
            ...
            <p className="text-caption" style={{ marginTop: "0.35rem" }}>
              Call any Zentra API. Build the request with <strong>Form</strong> fields (no JSON needed) or switch to <strong>Raw JSON</strong>. Your session token is sent automatically.{" "}
