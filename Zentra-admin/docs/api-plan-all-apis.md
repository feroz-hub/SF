# API plan: flow, specification, validation, and Zentra-admin alignment

This document covers **all APIs** used by Zentra-admin: server flow, validation/specifications, required fields, and admin alignment (including gaps). The Client API is documented in detail in [client-registration-plan.md](./client-registration-plan.md); here we reference it and document all other APIs in the same style.

**Server constants:** `ColumnLength255 = 255`, `ColumnLength2048 = 2048` ([Constants.cs](../../src/Identity/Zentra.Identity.Domain/Constants/Constants.cs)).
...
**Key files:** [RoleService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/RoleService.cs), [RoleModelSpecification.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Specifications/RoleModelSpecification.cs), [RoleClaimModelSpecification.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Specifications/RoleClaimModelSpecification.cs).
...
**Key files:** [ApiResourceService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/ApiResourceService.cs), [ApiResourceModelSpecification.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Specifications/ApiResourceModelSpecification.cs).
...
**Key files:** [ApiResourceService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/ApiResourceService.cs), [ApiScopeModelSpecification.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Specifications/ApiScopeModelSpecification.cs).
...
**Key files:** [IdentityResourceService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/IdentityResourceService.cs), [IdentityResourceModelSpecification.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Specifications/IdentityResourceModelSpecification.cs).
...
**Key files:** [IdentityResourceService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/IdentityResourceService.cs), [IdentityClaimModelSpecification.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Specifications/IdentityClaimModelSpecification.cs).
...
**Key files:** [UserAccountService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/UserAccountService.cs) (e.g. Email length 255, CreatedBy/ModifiedBy 255), [UserClaimModelSpecification.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Specifications/UserClaimModelSpecification.cs), [UserRoleService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/UserRoleService.cs).
...
**Key files:** [AuditTrailService.cs](../../src/Identity/Zentra.Identity.Application/Implementation/Api/Services/AuditTrailService.cs).

### 8.2 Zentra-admin alignment
