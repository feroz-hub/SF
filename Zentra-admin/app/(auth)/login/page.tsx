  ...
  return (
    <main className="login-shell">
      <section className="login-card">
        <p className="kicker">Zentra Administration</p>
        <h1>Admin Console</h1>
        <p>Sign in with your Zentra administrative account.</p>
        ...
        <div style={{ marginTop: "1rem" }}>
          <p className="inline-message" style={{ marginBottom: "0.5rem" }}>
            Or sign in with your Google account. Requires the Zentra Demo Server with Google sign-in enabled.
          </p>
          <Button
            type="button"
            variant="secondary"
