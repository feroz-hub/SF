      ...
      <header className="card-head">
        <div>
          ...
          <p className="inline-message">
            Protocol-level tooling for Zentra: OAuth/OIDC endpoints, gateway APIs, installer, and demo server flows.
          </p>
        </div>
      </header>
      <div className="card-body" style={{ display: "grid", gap: "1rem" }}>
        <div>
          ...
          <p className="inline-message" style={{ marginBottom: "0.5rem" }}>
            Explore and exercise the Zentra OAuth/OIDC endpoints (authorize, token, introspect, revocation, userinfo,
            discovery).
          </p>
